...
<head>
    ...
    <link rel="stylesheet" href="/SIR-project/assets/css/page-auth.css"/>
</head>
<body>
<?php 
    if(!empty($login_err)){
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/SIR-project/index.php" class="app-brand-link gap-2">
                        ...
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            >
                              ...
                              <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="/index.php"></use>
                            </g>
                          </g>
                        </g>
                      </g>
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Carlos Macho</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to the backoffice! 👋</h4>
              <p class="mb-4">Please sign-in to your account</p>
                ...
                <label for="email" class="form-label">Email or Username</label>
                  <input
                    type="text"
                    class="form-control form-control-lg <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>"
                    id="email"
                    name="username"
